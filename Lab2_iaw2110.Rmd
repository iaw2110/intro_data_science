...
diamonds <- read.csv(paste("C:/Users/iawol/Desktop/College/Junior Year/2nd Semester/",
"Stat Computing/Lab_2/diamonds_small.csv", sep=""),,
...
for (b in 1:B) {
  ...
  resample_data <- diamonds[resampled_rows, ]
  resampled_ests[b, ] <- coefficients(lm(price ~ carat, data=resample_data))
}
head(resampled_ests)
```
...
hist(resampled_ests[, "Slope_Est"], xlab = "Resampled Slope Estimates", 
     main = "Bootstrap Resamples")
```
